...
_G.unequip_tool = function(character, localPlayer)for _,child in ipairs(character:GetChildren())do if child:IsA("Tool")then child.Parent=localPlayerBag end end end
